% Weighted Least Squares (WLS) Solution with Potential Well Function (PWF)
...
while true
    clf
    [qdot,delta_p] = RRA_WLS_PWF(qcur,pcur,pd);
    ...
    getframe; % uncomment if rendering video
    %{
...
%{
% create video file
myWriter = VideoWriter('WLS-PWF', 'MPEG-4');
