...
% trajectory of the robotic arm, and creates an animation. (HW2 Prob3-Q5-4)
clc;
close all;
clear all;
...
while dist <= dist2goal
    ...
    dq = pinv(W)*J'*pinv(J*pinv(W)*J')*d_xdes;
...
hold off
% create video file
myWriter = VideoWriter('weighted-leastnorm.mp4', 'MPEG-4');
